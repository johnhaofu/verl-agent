...
class HorizonWorker:
    ...
    def __init__(self, seed: int, env_kwargs: dict, prompts_ref_box: dict):
        ...
        self.env = HorizonAgentEnv(
            ...
            empty_section_penalty=env_kwargs.get("empty_section_penalty", 0.0),
            unused_describe_penalty=env_kwargs.get("unused_describe_penalty", 0.0),
            used_describe_bonus=env_kwargs.get("used_describe_bonus", 0.0),
            repeat_submit_penalty=env_kwargs.get("repeat_submit_penalty", 0.0),
